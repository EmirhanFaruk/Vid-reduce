...
# Modification date: Thu Jun 23 13:27:48 2022

# Production date: Sun Sep  3 15:44:21 2023

"""

Source: https://www.thepythoncode.com/article/add-audio-to-video-in-python
...
vid_name = input("Enter the full video name: ")
aud_name = input("Enter the full audio name: ")
final_name = input("Enter the full final video name: ")
# load the video
video_clip = VideoFileClip(vid_name)
# load the audio
audio_clip = AudioFileClip(aud_name)
